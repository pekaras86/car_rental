...
if (isset($_GET['format'], $_GET['pickup'],$_GET['pick_date'], $_GET['drop_date'],$GET['category'])) {

//Set our variables
    $format = strtolower($_GET['format']);
    $pickup_location = intval($_GET['pickup']);
    $pickup_date = $_GET['pick_date'];
    $dropoff_date = $_GET['drop_date'];
...
//Run our query
    ...
    $result = getAvailableCarTypesAPI($con,$pickup_location, $pickup_date,$dropoff_date,$category);
