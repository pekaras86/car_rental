            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <form method="post" action="add_new_car.php" name="addcar"
                                    ...
                                    <div class="form-group">
                                        <table class="addcar">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" size="40" name="cname" class="form-control"
                                                           id="cname"
                                                           style="width:200px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                        <span class="btn btn-default btn-file"><input type="file" size="35" name="cimg"
                                                                                      id="cimg"></span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                        <textarea rows="4" cols="50" name="cdescription" id="cdescription"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" size="4" value="" name="cprice" id="cprice"
                                                           class="form-control" style="width:100px;">
                                                </td>
                                            <tr>
                                                <td>
                                                    <input type="submit" value="Submit" class="btn btn-default btn-file"
                                                           onClick="return addCarFields();">
                                                </td>
                                            </tr>
                                            </tr>
                                            </tbody>
